...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/clicker_android: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/clicker_android ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/67dd150d/font.o: /home/smorodin/NetBeansProjects/clicker_android/font.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/67dd150d
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/67dd150d/font.o /home/smorodin/NetBeansProjects/clicker_android/font.cpp

${OBJECTDIR}/_ext/67dd150d/gui.o: /home/smorodin/NetBeansProjects/clicker_android/gui.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/67dd150d
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/67dd150d/gui.o /home/smorodin/NetBeansProjects/clicker_android/gui.cpp

${OBJECTDIR}/_ext/67dd150d/tools.o: /home/smorodin/NetBeansProjects/clicker_android/tools.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/67dd150d
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/67dd150d/tools.o /home/smorodin/NetBeansProjects/clicker_android/tools.cpp
